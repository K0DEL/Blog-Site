...
from flask_login import UserMixin, login_user, LoginManager, login_required, current_user, logout_user  # noqa E501
...
class CommentForm(FlaskForm):
    comment = CKEditorField("New Comment", validators=[InputRequired()])
